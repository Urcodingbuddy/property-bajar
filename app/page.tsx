    ...
    <main className="min-h-screenflex flex-col">
      ...
      <section className="w-full flex justify-center mt-30">
        <div
          className="w-full max-w-[1242px] md:h-[203px] bg-white rounded-xl
                  flex md:flex-row flex-wrap justify-evenly
                  items-center md:gap-0 px-4 md:px-0"
        >
          {/* Card 1 */}
      ...
      <section className="w-full flex justify-center my-16">
        <div className="w-full max-w-7xl px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-w-7xl gap-6 mt-6">
            {/* CARD */}
      ...
      <section className="w-full flex flex-col items-center gap-10 mt-30 mb-16 pt-10 pb-20">
        ...
        <div className="w-full bg-white p-10 flex flex-col justify-center items-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-w-7xl gap-6">
            {/* CARD */}
